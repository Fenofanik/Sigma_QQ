                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              decoration: InputDecoration(
                                ...
                                enabledBorder: styleForSearchBorder,
                                focusedBorder: styleForSearchBorder,
                                errorBorder: styleForSearchBorder,
                                focusedErrorBorder: styleForSearchBorder,
                              ),
                            ),
                          ),
                        ),
      ...
      body: Container(
        ...
        child: Column(
          children: [
            Row(
              children: [
                  ...
                  child: Padding(
                    ...
                    child: TextFormField(
                      decoration: InputDecoration(
                        ...
                        filled: true,
                        prefixIcon:
                            Icon(Icons.search, size: 18, color: SearchIcon),
                        hintText: "Поиск",
                        hintStyle: style_2,
                        contentPadding: const EdgeInsets.only(left: 10),
                        enabledBorder: styleForSearchBorder,
                ...
                Expanded(
                  child: Padding(
                    padding:
                        const EdgeInsets.only(top: 50, right: 19, left: 19),
                    child: IconButton(
                        onPressed: () {},
                        icon: Icon(
                          Icons.filter_list,
            ...
            Expanded(
                child: Image.asset('assets/3x/NoHistory.png',
