        ...
        child: Column(
            ...
            children: [
             Padding(
                  ...
                  child: IconButton(
                      ...
                      icon: Icon (Icons.arrow_back,size: 16,color: whiteColors,)),
                ),
              Padding(
          ...
          Wrap(
              ...
              children: <Widget>[
                ...
                Padding(
                    ...
                    child: ElevatedButton(onPressed: (){},
                      ...
                      child: Text("Красота и здоровье ",style: TextStyles().style_6,),
                    ),
                  ),
              ],
          ),
            ...
            Padding(
              ...
              child: Wrap(
              children: <Widget>[
                Icon(Icons.check_box_outline_blank,size: 20,color: CategoryButton1,),
                Padding(
